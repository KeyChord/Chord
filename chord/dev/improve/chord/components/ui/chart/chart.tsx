...
import type { TooltipValueType } from '@chord/com.npmjs.recharts';
import * as RechartsPrimitive from '@chord/com.npmjs.recharts';
...
const REACT_ID_SEPARATOR_REGEX = /:/g;
...
function ChartContainer({
	...
	const chartId = `chart-${id ?? uniqueId.replace(REACT_ID_SEPARATOR_REGEX, '')}`;
