...
var o = (e, t) => bt(e, "name", { value: t, configurable: !0 }),
  N = ((e) =>
    typeof require < "u"
      ? require
      : typeof Proxy < "u"
...
var B = A((Ls, jn) => {
  "use strict";
  var { SymbolAsyncIterator: Tn, SymbolIterator: In, SymbolFor: ne } = T(),
    Mn = ne("nodejs.stream.destroyed"),
    kn = ne("nodejs.stream.errored"),
    _t = ne("nodejs.stream.readable"),
    yt = ne("nodejs.stream.writable"),
    Nn = ne("nodejs.stream.disturbed"),
    mo = ne("nodejs.webstream.isClosedPromise"),
    To = ne("nodejs.webstream.controllerErrorFunction");
  function Ce(e, t = !1) {
    var n;
    return !!(
      e &&
...
var L = A((Ws, Un) => {
  "use strict";
  var { format: jo, inspect: Fe } = wt(),
    { AggregateError: Fo } = T(),
    vo = globalThis.AggregateError || Fo,
    Bo = Symbol("kIsNodeError"),
    Uo = [
      "string",
      "function",
      "number",
    ...
    ve = {};
  function re(e, t) {
    if (!e) throw new ve.ERR_INTERNAL_ASSERTION(t);
  }
  o(re, "assert");
  function vn(e) {
    let t = "",
  ...
  D(
    ...
    (e, t, n) => {
      ...
      let r;
      if (Number.isInteger(n) && Math.abs(n) > 2 ** 32) r = vn(String(n));
...
var he = A((Cs, Be) => {
  "use strict";
  var { AbortController: Hn, AbortSignal: Ko } =
...
var O = A(($s, Et) => {
  "use strict";
  var zo = N("buffer"),
    { format: Xo, inspect: Jo } = wt(),
    {
      codes: { ERR_INVALID_ARG_TYPE: St },
    } = L(),
    { kResistStopPropagation: Qo, AggregateError: Zo, SymbolDispose: el } = T(),
    tl = globalThis.AbortSignal || he().AbortSignal,
    nl = globalThis.AbortController || he().AbortController,
    rl = Object.getPrototypeOf(async function () {}).constructor,
    Gn = globalThis.Blob || zo.Blob,
    il = o(
      typeof Gn < "u"
        ? function (t) {
    ...
    ol = o((e, t) => {
      if (typeof e != "function") throw new St(t, "Function", e);
    }, "validateFunction");
  Et.exports = {
    AggregateError: Zo,
    ...
    addAbortListener:
      ...
      o(function (t, n) {
        if (t === void 0) throw new St("signal", "AbortSignal", t);
...
var pe = A((Fs, nr) => {
  ...
  var {
    ...
    { normalizeEncoding: _l } = O(),
    { isAsyncFunction: yl, isArrayBufferView: wl } = O().types,
    Kn = {};
  function gl(e) {
    return e === (e | 0);
  }
  ...
  o(Sl, "isUint32");
  var El = /^[0-7]+$/,
    Rl = "must be a 32-bit unsigned integer or an octal string";
  function Al(e, t, n) {
    if ((typeof e > "u" && (e = n), typeof e == "string")) {
      if (Qn(El, e) === null) throw new be(t, e, Rl);
      e = sl(e, 8);
    }
    return (Zn(e, t), e);
  }
  o(Al, "parseFileMode");
  var ml = C((e, t, n = ul, r = fl) => {
      if (typeof e != "number") throw new P(t, "number", e);
      if (!mt(e)) throw new ie(t, "an integer", e);
      if (e < n || e > r) throw new ie(t, `>= ${n} && <= ${r}`, e);
    }),
    Tl = C((e, t, n = -2147483648, r = 2147483647) => {
      if (typeof e != "number") throw new P(t, "number", e);
      if (!mt(e)) throw new ie(t, "an integer", e);
      if (e < n || e > r) throw new ie(t, `>= ${n} && <= ${r}`, e);
    }),
  ...
  var kl = C((e, t, n = null) => {
      let r = Rt(n, "allowArray", !1),
        i = Rt(n, "allowFunction", !1);
      if (
  ...
  var Ol = C((e, t = "buffer") => {
    if (!wl(e)) throw new P(t, ["Buffer", "TypedArray", "DataView"], e);
  });
  function Wl(e, t) {
    let n = _l(t),
      r = e.length;
  ...
  var tr = C((e, t) => {
    ...
    $l = C((e, t) => {
      if (typeof e != "function" || yl(e)) throw new P(t, "Function", e);
    }),
    jl = C((e, t) => {
      if (e !== void 0) throw new P(t, "undefined", e);
    });
  function Fl(e, t, n) {
    if (!Xn(n, e)) throw new P(t, `('${Jn(n, "|")}')`, e);
  }
  o(Fl, "validateUnion");
  var vl = /^(?:<[^>]*>)(?:\s*;\s*[^;"\s]+(?:=(")?[^;"\s]*\1)?)*$/;
  function zn(e, t) {
  ...
  function Bl(e) {
    if (typeof e == "string") return (zn(e, "hints"), e);
    if (At(e)) {
      let t = e.length,
        n = "";
      if (t === 0) return n;
...
var Y = A((Bs, qt) => {
  "use strict";
  var Q = N("process"),
    { AbortError: dr, codes: Ul } = L(),
    { ERR_INVALID_ARG_TYPE: Hl, ERR_STREAM_PREMATURE_CLOSE: rr } = Ul,
    { kEmptyObject: Mt, once: kt } = O(),
    {
    ...
    { Promise: zl, PromisePrototypeThen: Xl, SymbolDispose: cr } = T(),
    {
      isClosed: Jl,
      isReadable: ir,
  ...
  function hr(e, t, n) {
    ...
    if (
      ...
      return ia(e, t, n);
    if (!ea(e)) throw new Hl("stream", ["ReadableStream", "WritableStream", "Stream"], e);
    let l = (r = t.readable) !== null && r !== void 0 ? r : It(e),
      a = (i = t.writable) !== null && i !== void 0 ? i : fr(e),
      u = e._writableState,
      s = e._readableState,
      f = o(() => {
        e.writable || p();
      }, "onlegacyfinish"),
      d = ta(e) && It(e) === l && fr(e) === a,
      c = ur(e, !1),
      p = o(() => {
      ...
      y = o(() => {
        ...
        if (l && !h && It(e, !0) && !or(e, !1)) return n.call(e, new rr());
        if (a && !c && !ur(e, !1)) return n.call(e, new rr());
        n.call(e);
      }, "onclose"),
      R = o(() => {
        E = !0;
    ...
    if (t.signal && !E) {
      ...
      if (t.signal.aborted) Q.nextTick(M);
      else {
        _e = _e || O().addAbortListener;
        let te = _e(t.signal, M),
          x = n;
        n = kt((...ce) => {
          (te[cr](), x.apply(e, ce));
        });
...
var oe = A((Hs, Er) => {
  ...
  var U = N("process"),
    ...
    { Symbol: _r } = T(),
    { kIsDestroyed: ua, isDestroyed: sa, isFinished: da, isServerRequest: ca } = B(),
    yr = _r("kDestroy"),
    Dt = _r("kConstruct");
  function wr(e, t, n) {
...
var Ve = A((Vs, Ar) => {
  "use strict";
  var { ArrayIsArray: Ea, ObjectSetPrototypeOf: Rr } = T(),
    { EventEmitter: He } = N("events");
  function Ge(e) {
    He.call(this, e);
  }
  o(Ge, "Stream");
...
var Ie = A((Ks, Ye) => {
  "use strict";
  var { SymbolDispose: Ra } = T(),
    { AbortError: mr, codes: Aa } = L(),
    { isNodeStream: Tr, isWebStream: ma, kControllerErrorFunction: Ta } = B(),
    Ia = Y(),
    { ERR_INVALID_ARG_TYPE: Ir } = Aa,
    Wt,
    Ma = o((e, t) => {
      if (typeof e != "object" || !("aborted" in e)) throw new Ir(t, "AbortSignal", e);
    }, "validateAbortSignal");
  Ye.exports.addAbortSignal = o(function (t, n) {
...
var Nr = A((Js, kr) => {
  ...
  kr.exports = class {
    ...
    *[ka]() {
    ...
    _getBuffer(t) {
      let n = xt.allocUnsafe(t),
        r = t,
        i = this.head,
        l = 0;
      do {
        let a = i.data;
        if (t > a.length) (Ke(n, a, r - t), (t -= a.length));
        else {
          t === a.length
...
var Me = A((Zs, Pr) => {
  "use strict";
  var { MathFloor: Da, NumberIsInteger: La } = T(),
    { validateInteger: Pa } = pe(),
    { ERR_INVALID_ARG_VALUE: Oa } = L().codes,
    qr = 16 * 1024,
    Dr = 16;
  function Wa(e, t, n) {
...
var Ct = A((td, Cr) => {
  "use strict";
  var Or = N("process"),
    { PromisePrototypeThen: $a, SymbolAsyncIterator: Wr, SymbolIterator: xr } = T(),
    { Buffer: ja } = N("buffer"),
    { ERR_INVALID_ARG_TYPE: Fa, ERR_STREAM_NULL_VALUES: va } = L().codes;
  function Ba(e, t, n) {
    let r;
    ...
    let i;
    if (t && t[Wr]) ((i = !0), (r = t[Wr]()));
    else if (t && t[xr]) ((i = !1), (r = t[xr]()));
...
var Ne = A((rd, ti) => {
  ...
  ti.exports = _;
  _.ReadableState = Qe;
  var { EventEmitter: Qa } = N("events"),
    { Stream: Z, prependListener: Za } = Ve(),
    { Buffer: $t } = N("buffer"),
    { addAbortSignal: ef } = Ie(),
    Br = Y(),
    ...
    tf = Nr(),
    ge = oe(),
    { getHighWaterMark: nf, getDefaultHighWaterMark: rf } = Me(),
    {
    ...
    { validateObject: df } = pe(),
    le = Ja("kPaused"),
    { StringDecoder: Ur } = N("string_decoder/"),
    cf = Ct();
  Fr(_.prototype, Z.prototype);
  Fr(_, Z);
  var jt = o(() => {}, "nop"),
    { errorOrDestroy: ye } = ge,
    we = 1,
    hf = 2,
    Hr = 4,
    ke = 8,
  ...
  function Kr(e, t, n, r) {
    ...
    if (
      ...
      ye(e, l);
    else if (t === null) ((i.state &= ~ke), mf(e, i));
    else if ((i.state & we) !== 0 || (t && t.length > 0))
      if (r)
        if ((i.state & Hr) !== 0) ye(e, new uf());
        else {
          if (i.destroyed || i.errored) return !1;
          Ft(e, i, t, !0);
        }
      else if (i.ended) ye(e, new ff());
      else {
        if (i.destroyed || i.errored) return !1;
        ((i.state &= ~ke),
          i.decoder && !n
  ...
  var Rf = 1073741824;
  function Af(e) {
    if (e > Rf) throw new af("size", "<= 1GiB", e);
    return (
  ...
  _.prototype.read = function (e) {
    (w("read", e), e === void 0 ? (e = NaN) : Ha(e) || (e = Va(e, 10)));
    ...
    if (((e = jr(e, t)), e === 0 && t.ended)) return (t.length === 0 && vt(this), null);
    let r = (t.state & Xe) !== 0;
    if (
      (w("need readable", r),
  ...
  _.prototype.pipe = function (e, t) {
    ...
    let l = (!t || t.end !== !1) && e !== j.stdout && e !== j.stderr ? u : E;
...
var it = A((od, hi) => {
  ...
  hi.exports = I;
  I.WritableState = Le;
  var { EventEmitter: $f } = N("events"),
    qe = Ve().Stream,
    { Buffer: et } = N("buffer"),
    rt = oe(),
    { addAbortSignal: jf } = Ie(),
    { getHighWaterMark: Ff, getDefaultHighWaterMark: vf } = Me(),
    {
    ...
    { errorOrDestroy: Se } = rt;
  ai(I.prototype, qe.prototype);
  ai(I, qe);
  function Kt() {}
  o(Kt, "nop");
  var Ee = xf("kOnFinished");
  function Le(e, t, n) {
    (typeof n != "boolean" && (n = t instanceof H()),
  ...
  function si(e, t, n, r) {
    ...
    if (typeof n == "function") ((r = n), (n = i.defaultEncoding));
      ...
      else if (n !== "buffer" && !et.isEncoding(n)) throw new ui(n);
      typeof r != "function" && (r = Kt);
    }
    if (t === null) throw new Vf();
    if (!i.objectMode)
      if (typeof t == "string") i.decodeStrings !== !1 && ((t = et.from(t, n)), (n = "buffer"));
      else if (t instanceof et) n = "buffer";
      else if (qe._isUint8Array(t)) ((t = qe._uint8ArrayToBuffer(t)), (n = "buffer"));
  ...
  I.prototype.setDefaultEncoding = o(function (t) {
    if ((typeof t == "string" && (t = Wf(t)), !et.isEncoding(t))) throw new ui(t);
...
var ki = A((ad, Mi) => {
  var Qt = N("process"),
    ...
    Ii = Ne(),
    au = it(),
    { createDeferredPromise: Ei } = O(),
    Ri = Ct(),
    Ai = globalThis.Blob || eu.Blob,
    fu = o(
      typeof Ai < "u"
        ? function (t) {
    ...
    uu = globalThis.AbortController || he().AbortController,
    { FunctionPrototypeCall: mi } = T(),
    ee = class extends lu {
      static {
        o(this, "Duplexify");
      }
  ...
  Mi.exports = o(function e(t, n) {
    if (iu(t)) return t;
    if (pi(t)) return Re({ readable: t });
    if (_i(t)) return Re({ writable: t });
    if (ru(t)) return Re({ writable: !1, readable: !1 });
    if (yi(t)) return Re({ readable: Ii.fromWeb(t) });
    if (wi(t)) return Re({ writable: au.fromWeb(t) });
    if (typeof t == "function") {
      let { value: i, write: l, final: a, destroy: u } = su(t);
      if (bi(i)) return Ri(ee, i, { objectMode: !0, write: l, final: a, destroy: u });
      let s = i?.then;
      if (typeof s == "function") {
        let f,
          d = mi(
            ...
            i,
            (c) => {
              if (c != null) throw new Si("nully", "body", c);
            },
            (c) => {
              Ae(f, c);
            },
    ...
    if (fu(t)) return e(t.arrayBuffer());
    if (bi(t)) return Ri(ee, t, { objectMode: !0, writable: !1 });
    if (yi(t?.readable) && wi(t?.writable)) return ee.fromWeb(t);
    if (typeof t?.writable == "object" || typeof t?.readable == "object") {
      let i = t != null && t.readable ? (pi(t?.readable) ? t?.readable : e(t.readable)) : void 0,
        l = t != null && t.writable ? (_i(t?.writable) ? t?.writable : e(t.writable)) : void 0;
      ...
      value: e(
        (async function* () {
          for (;;) {
            ...
            if ((Qt.nextTick(f), s)) return;
            if (i.aborted) throw new Ti(void 0, { cause: i.reason });
  ...
  o(su, "fromAsyncGen");
  function Re(e) {
    let t = e.readable && typeof e.readable.read != "function" ? Ii.wrap(e.readable) : e.readable,
      n = e.writable,
      r = !!tu(t),
      i = !!nu(n),
      l,
...
var on = A((dd, Pi) => {
  "use strict";
  var { ObjectSetPrototypeOf: Li, Symbol: hu } = T();
  Pi.exports = z;
  var { ERR_METHOD_NOT_IMPLEMENTED: bu } = L().codes,
    rn = H(),
    { getHighWaterMark: pu } = Me();
...
var ft = A((pd, Fi) => {
  var Oe = N("process"),
    { ArrayIsArray: yu, Promise: wu, SymbolAsyncIterator: gu, SymbolDispose: Su } = T(),
    at = Y(),
    { once: Eu } = O(),
    Ru = oe(),
    xi = H(),
    ...
    { validateFunction: ku, validateAbortSignal: Nu } = pe(),
    {
      isIterable: fe,
      isReadable: un,
    ...
    Lu = globalThis.AbortController || he().AbortController,
    dn,
    cn,
    hn;
  function $i(e, t, n) {
    ...
    let i = at(e, { readable: t, writable: n }, (l) => {
      r = !l;
    });
    return {
      destroy: o((l) => {
  ...
  o($i, "destroyer");
  function Pu(e) {
    return (ku(e[e.length - 1], "streams[stream.length - 1]"), e.pop());
  }
  o(Pu, "popCallback");
  function bn(e) {
    if (fe(e)) return e;
  ...
  o(Wu, "pipeline");
  function ji(e, t, n) {
    if ((e.length === 1 && yu(e[0]) && (e = e[0]), e.length < 2)) throw new mu("streams");
    let r = new Lu(),
      i = r.signal,
      l = n?.signal,
      a = [];
    ...
    for (let k = 0; k < e.length; k++) {
      ...
      if (Ci(g)) {
        ...
        var R = W;
        if ((o(W, "onError"), x)) {
          let { destroy: V, cleanup: ht } = $i(g, M, te);
      ...
      if (k === 0)
        ...
        } else fe(g) || lt(g) || Te(g) ? (b = g) : (b = xi.from(g));
        ...
        if (((b = g(b, { signal: i })), M)) {
          if (!fe(b, !0)) throw new fn("AsyncIterable", `transform[${k - 1}]`, b);
        } else {
          var y;
          dn || (dn = an());
          let W = new dn({ objectMode: !0 }),
            V = (y = b) === null || y === void 0 ? void 0 : y.then;
          ...
          else if (fe(b, !0)) (p++, ot(b, W, h, { end: x }));
          else if (sn(b) || Te(b)) {
            let J = b.readable || b;
            (p++, ot(J, W, h, { end: x }));
          } else throw new fn("AsyncIterable or Promise", "destination", b);
          b = W;
          let { destroy: ht, cleanup: _o } = $i(b, !1, !0);
          (c.push(ht), ce && a.push(_o));
        }
      } else if (Ci(g)) {
        if (lt(b)) {
          p += 2;
          let W = xu(b, g, h, { end: x });
          un(g) && ce && a.push(W);
        } else if (Te(b) || sn(b)) {
          let W = b.readable || b;
          (p++, ot(W, g, h, { end: x }));
        } else if (fe(b)) (p++, ot(b, g, h, { end: x }));
        else
          throw new _n(
            "val",
        ...
        if (lt(b)) (p++, pn(bn(b), g, h, { end: x }));
        else if (sn(b) || fe(b)) (p++, pn(b, g, h, { end: x }));
        else if (Te(b)) (p++, pn(b.readable, g, h, { end: x }));
        else
          throw new _n(
            "val",
            ["Readable", "Iterable", "AsyncIterable", "ReadableStream", "TransformStream"],
...
var wn = A((yd, Vi) => {
  ...
  var { pipeline: Cu } = ft(),
    ...
    vu = Y();
  Vi.exports = o(function (...t) {
    if (t.length === 0) throw new Fu("streams");
    if (t.length === 1) return ut.from(t[0]);
    let n = [...t];
    if (
      (typeof t[0] == "function" && (t[0] = ut.from(t[0])), typeof t[t.length - 1] == "function")
    ) {
      let h = t.length - 1;
      t[h] = ut.from(t[h]);
    }
    ...
    if (
      ...
      if (st(f))
        ...
        let b = (ue(f) ? f.writable : f).getWriter();
    ...
    if (p) {
      if (st(d))
        ...
        let S = (ue(d) ? d.readable : d).getReader();
        u._read = async function () {
          for (;;)
            try {
              let { value: b, done: E } = await S.read();
              if (!u.push(b)) return;
              if (E) {
                u.push(null);
                return;
...
var no = A((gd, En) => {
  "use strict";
  var Bu = globalThis.AbortController || he().AbortController,
    {
      codes: {
    ...
    { validateAbortSignal: se, validateInteger: Yi, validateObject: de } = pe(),
    Vu = T().Symbol("kWeak"),
    Yu = T().Symbol("kResistStopPropagation"),
    { finished: Ku } = Y(),
    zu = wn(),
    { addAbortSignalNoValidate: Xu } = Ie(),
    { isWritable: Ju, isNodeStream: Qu } = B(),
    { deprecate: Zu } = O(),
    {
  ...
  o(os, "compose");
  function ct(e, t) {
    if (typeof e != "function") throw new We("fn", ["Function", "AsyncFunction"], e);
    ...
    return (
      ...
      (r += n),
      o(async function* () {
        let l = O().AbortSignalAny([t?.signal].filter(ts)),
          a = this,
          u = [],
          s = { signal: l },
          f,
        ...
        async function E() {
          try {
            for await (let y of a) {
              if (c) return;
              if (l.aborted) throw new G();
              try {
                if (((y = e(y, s)), y === dt)) continue;
                y = is(y);
              } catch (R) {
                y = Xi(R);
              }
  ...
  async function eo(e, t = void 0) {
    for await (let n of Sn.call(this, e, t)) return !0;
    return !1;
  }
  o(eo, "some");
  ...
  async function fs(e, t) {
    for await (let n of Sn.call(this, e, t)) return n;
  }
  o(fs, "find");
  async function us(e, t) {
    ...
    o(n, "forEachFn");
    for await (let r of ct.call(this, n, t));
  }
  o(us, "forEach");
  function Sn(e, t) {
    if (typeof e != "function") throw new We("fn", ["Function", "AsyncFunction"], e);
  ...
  o(cs, "flatMap");
  function to(e) {
    if (((e = ns(e)), rs(e))) return 0;
    if (e < 0) throw new Gu("number", ">= 0", e);
    return e;
  }
  ...
  function hs(e, t = void 0) {
    return (
      ...
      o(async function* () {
        var r;
        if (t != null && (r = t.signal) !== null && r !== void 0 && r.aborted) throw new G();
        for await (let l of this) {
          var i;
          if (t != null && (i = t.signal) !== null && i !== void 0 && i.aborted) throw new G();
          e-- <= 0 && (yield l);
        }
      }, "drop").call(this)
    );
...
var ho = A((Ed, co) => {
  "use strict";
  var { Buffer: ps } = N("buffer"),
    { ObjectDefineProperty: X, ObjectKeys: oo, ReflectApply: lo } = T(),
    {
      promisify: { custom: ao },
    } = O(),
    { streamReturningOperators: ro, promiseReturningOperators: io } = no(),
    {
      codes: { ERR_ILLEGAL_CONSTRUCTOR: fo },
    } = L(),
    _s = wn(),
    { setDefaultHighWaterMark: ys, getDefaultHighWaterMark: ws } = Me(),
    { pipeline: uo } = ft(),
    { destroyer: gs } = oe(),
    so = Y(),
    Rn = An(),
    xe = B(),
    m = (co.exports = Ve().Stream);
  ...
  m.Stream = m;
  m._isUint8Array = o(function (t) {
    return t instanceof Uint8Array;
  }, "isUint8Array");
  m._uint8ArrayToBuffer = o(function (t) {
    return ps.from(t.buffer, t.byteOffset, t.byteLength);
  }, "_uint8ArrayToBuffer");
});
var An = A((Ad, bo) => {
  "use strict";
  var { ArrayPrototypePop: Es, Promise: Rs } = T(),
    { isIterable: As, isNodeStream: ms, isWebStream: Ts } = B(),
    { pipelineImpl: Is } = ft(),
    { finished: Ms } = Y();
  ho();
  function ks(...e) {
...
var export_pipeline = po.pipeline;
